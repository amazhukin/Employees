...
//   //     const state = inject('employeeStore') as IEmployeeState;
...
//   //     const state = inject('employeeStore') as IEmployeeState;
//   //     const index = state.items.findIndex((item: IEmployee) => item.id === employee.id);
//   //     if (index !== -1) {
...
//   //     const state = inject('employeeStore') as IEmployeeState;
//   //     const index = state.items.findIndex((item: IEmployee) => item.id === id);
//   //     if (index !== -1) {
